...
class Trainer():
    ...
    def train(self, epoch = 1, verbose = True):
        ...
        checkpoint = ModelCheckpoint(filepath, monitor=self.monitor, verbose=1, save_best_only=True, mode='max')
    ...
    def load(self):
        ...
        self.model = keras.models.load_model('models/{}.checkpoint.pth.h5'.format(self.name))
